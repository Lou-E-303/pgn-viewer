...
export const moveToId = (move) => isDrop(move) ? 'drop' : `${toChar(move.from)}${toChar(move.to, move.promotion)}`;
const shiftChar = 35;
const voidChar = 33;
const squareChar = (square) => String.fromCharCode(square + shiftChar);
...
//     }
//     .to(Map)
const toChar = (square, promotion) => squareChar(square);
export const uciToId = (uci) => moveToId(parseUci(uci));
